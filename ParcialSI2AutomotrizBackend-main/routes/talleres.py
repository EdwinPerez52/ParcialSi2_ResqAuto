...
def listar_especialidades(usuario: dict = Depends(verificar_auth), conn = Depends(get_db)):
...
def obtener_especialidades_taller(taller_id: int, usuario: dict = Depends(verificar_auth), conn = Depends(get_db)):
...
def obtener_tecnicos(taller_id: int, usuario: dict = Depends(verificar_auth), conn = Depends(get_db)):
